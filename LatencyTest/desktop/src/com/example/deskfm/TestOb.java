...
public class TestOb extends FMeObject {
	...
	public void deserialize(FMeObject serObject) {
		...
		System.out.println("Test Object: deserialized(FMeObject)");
	...
	public void changedObject() {
		// TODO Auto-generated method stub
		System.out.println("Test object: Received a change notification!");
		this.setChanged();
	...
	public void deletedObject() {
		// TODO Auto-generated method stub
		System.out.println("Test object: Received a delete notification!");
		this.setChanged();
		this.notifyObservers();
