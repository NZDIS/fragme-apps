...
public class PingTestDesktop {
	...
	public PingTestDesktop() {
		...
		ControlCenter.DEBUG_CHANNEL_SETUP = false;
		ControlCenter.DEBUG_SYNCHRONIZATION = false;
		//ControlCenter.DEBUG_SENDING = true;
		...
		if (ControlCenter.getNoOfPeers() == 0) {
			...
			previousCounter = pingPacket.getCounter();
		} else {
			...
			previousCounter = pingPacket.getCounter() - 1;
